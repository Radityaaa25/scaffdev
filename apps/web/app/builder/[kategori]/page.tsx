...
export const metadata: Metadata = {
  ...
  description: "Langkah kategori Builder Scaffdev segera hadir. Sementara itu pakai katalog template.",
};
    ...
    <main className="flex flex-1 items-center justify-center p-8">
      <div className="w-full max-w-xl rounded-2xl border border-amber-500/25 bg-amber-500/[0.04] p-8 text-center">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-400">
          Langkah kategori → framework → racikan custom masih disiapkan.
