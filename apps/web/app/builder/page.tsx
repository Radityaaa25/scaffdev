...
export const metadata: Metadata = {
  ...
  description:
    "Builder Scaffdev (segera hadir): pilih template base dan centang integrasi favoritmu. Sementara itu pakai katalog template yang sudah live.",
};
    ...
    <main className="flex flex-1 items-center justify-center p-8">
      <div className="w-full max-w-xl rounded-2xl border border-amber-500/25 bg-amber-500/[0.04] p-8 text-center">
        ...
        <p className="mt-3 text-sm leading-relaxed text-zinc-400">
          Pilih satu template sebagai fondasi, centang integrasi favoritmu
          (maks 1 per kategori: payment, database, auth), dan dapatkan command
          custom. Fitur ini masih disiapkan.
        </p>
